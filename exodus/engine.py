...
class TradingEngine:
    ...
    def run(self):
        ...
        print(f"INFO: [{str(datetime.now())}] Trading engine has stopped")

# Create a global instance of the TradingEngine
trading_engine = TradingEngine()

# The following functions can be called from your Flask routes

def start_trading():
    return trading_engine.start()

def stop_trading():
    return trading_engine.stop()
